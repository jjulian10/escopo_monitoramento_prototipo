import {
  ...
  export default function ProjectActions({
    ...
    /* ==========================================================
       ...
       Agora atualizamos a lista compartilhada.
  
       Isso significa que a nova tarefa também
       ficará disponível no Kanban.
       ========================================================== */
    ...
    function adicionarTarefa(
      ...
      /*
       * Expande automaticamente a nova tarefa
       * após sua criação.
       */
    ...
    function excluirTarefa(
      ...
      /*
       * Remove também da lista de itens expandidos.
       */
    ...
    /* ==========================================================
       ...
       Em vez de usar tarefas.length + 1,
       calculamos o maior número existente.
  
       Isso evita repetir números caso alguma
       tarefa seja excluída.
       ========================================================== */
